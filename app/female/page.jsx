      ...
      {end ? (
        ...
        <div>
          <div className="mx-4 lg:mx-0">
            <h2 className="lg:text-3xl lg:font-bold text-center md:text-2xl md:font-bold text-xl font-bold mt-5 ">
              ...
              {/* ending here side pic */}
            </h2>
          </div>
          {/* Quiz section started here */}
          {data[currentIndex].options.map((answer, index) => {
            return (
              <div key={answer.opt} className=" mx-4 lg:mx-0">
                <div
                  className={`p-2 bg-gray-100 gap-2 h-28 flex items-center w-full md:w-8/12 lg:w-4/12 rounded-xl m-auto mt-5 ${
